...
async function config() {
    await fetch('/financio/get', {
      ...
      .then(result => {
       localStorage.setItem('trans',JSON.stringify(Object.values(result)))   
      })
      .catch(error => {
        console.log(error);
      });
    transactions = localStorage.getItem("trans") !== null ? JSON.parse(localStorage.getItem("trans")) : [];
    trans.innerHTML = "";
